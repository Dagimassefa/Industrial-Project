...
<html lang="en">
    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="uppercase tracking-loose w-full">Welcome to remote maintenance enquiry support system for AAU.</p>
          <h1 class="my-4 text-5xl font-bold leading-tight">
            AAU Remote Computer Support Team.
          </h1>
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
            <img class="w-50" src="
            {{asset('images/sis2.jpg')}}" alt="" class="logo"
        />
        </div>
      </div>
    </div>
 ...
 Personalized communication
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
               If you cannot get hold of technicians or they are not currently available you can chat with out AI bot which will give you guidance on maintaining some issues, with messages that have been prerecorded.
              </p>
            </a>
          </div>
          <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      ...
      Remote maintenance enquiry and technical support system is a site that will provide with the technical support and guidance you need in order to get maintenance services for all your devices. It is also equipped with an AI chat bot that will guide you through some basic maintenance process incase technicians are on leave or currently unavailable or if the problem is easily fixable. It is a site that has a dedicated team of technicians ready to assist you on your maintenance issue either remotely or physically. 
      </p>
     
    </section>

    <a href="https://aau-maintenance-bot.netlify.app/" target="_blank"><button title="Need a support? Chat Now!"
    class="fixed z-90 bottom-10 right-8 bg-blue-600 w-20 h-20 rounded-full drop-shadow-lg flex justify-center items-center text-white text-4xl hover:bg-blue-700 hover:drop-shadow-2xl hover:animate-bounce duration-300  bg-white text-gray-800 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out" id="some-button">&#129302;</button></a>
    <script>
      document.getElementById("some-button").style.display = "none";

      function showStuff() {
          document.getElementById("some-button").style.display = "flex";
      }
          ...
          <div class="flex-1">
            ...
            <ul class="list-reset mb-6">
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="https://aau-maintenance-bot.netlify.app/" class="no-underline hover:underline text-gray-800 hover:text-pink-500" target="_blank">AI Bot</a>
              </li>
